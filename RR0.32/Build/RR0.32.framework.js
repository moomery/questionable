...
var ASM_CONSTS = {
  4522464: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4522519: ($0) => { performance.now = function() { return $0; }; },  
 4522567: ($0) => { performance.now = function() { return $0; }; },  
 4522615: () => { performance.now = Module['emscripten_get_now_backup']; }
};
